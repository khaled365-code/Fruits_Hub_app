      ...
      [
        GestureDetector(
          ...
          child: Container(
            ...
            child: Center(child:
            LocalizationCubit().currentLanguage=='ar'?
            SvgPicture.asset(ImageConstants.arrowBackIcon):
            Transform.rotate(angle:  3.1415926536 ,child: SvgPicture.asset(ImageConstants.arrowBackIcon))
            ),
          ),
        ),
        Spacer(),
