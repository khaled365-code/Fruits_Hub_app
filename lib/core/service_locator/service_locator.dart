...
setUpLocator()
{
  ...
  locator.registerLazySingleton<AuthRepoImplementation>(() => AuthRepoImplementation(firebaseAuthService: locator.get<FirebaseAuthService>()),);
  locator.registerFactory<LoginBloc>(() => LoginBloc(),);
  locator.registerFactory<SignupCubit>(() => SignupCubit(authRepo: locator.get<AuthRepoImplementation>()),);
