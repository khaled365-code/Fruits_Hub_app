...
import 'package:fruits_commerce_app/core/widgets/shared_circular_progress_indicator_widget.dart';
    ...
    return Scaffold(
      ...
      builder: (context, state) {
        return ModalProgressHUD(
         inAsyncCall: state.requestState==RequestStates.loading?true:false,
